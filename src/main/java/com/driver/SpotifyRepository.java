...
public class SpotifyRepository {
    ...
    public User createUser(String name, String mobile) {
        ...
        for(User user: users){
            if(mobile.equals(user.getMobile())) return user;
        }
    ...
    public Album createAlbum(String title, String artistName) {
        ...
        List<Album> tempAlbumList = artistAlbumMap.getOrDefault(artist,new ArrayList<>());
        tempAlbumList.add(tempAlbum);
        artistAlbumMap.put(artist,tempAlbumList);
        return tempAlbum;
    }
